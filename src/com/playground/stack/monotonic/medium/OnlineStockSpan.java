package com.playground.stack.monotonic.medium;
...
public class OnlineStockSpan {
    ...
    /**
     * Runtime 21 ms Beats 95.63%
     * Memory 54.3 MB Beats 93.42%
     */
    static class StockSpanner {
        ...
        public int next(int price) {
            ...
            while (!stack.isEmpty() && stack.getLast().val <= price) {
                Stock stock = stack.removeLast();
                days += stock.days;
            }

            stack.addLast(new Stock(price, days));
